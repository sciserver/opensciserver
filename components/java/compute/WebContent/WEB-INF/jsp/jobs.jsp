<%-- Copyright (c) Johns Hopkins University. All rights reserved. Licensed under the Apache License, Version 2.0. See
    ...
    <%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
      <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
          ...
          <head>
            <%@ include file="../jspf/bootstrap-header.jspf" %>
              <link rel="stylesheet" type="text/css"
                href="https://cdn.datatables.net/v/bs/dt-1.10.15/b-1.4.0/datatables.min.css" />
              <link rel="stylesheet"
          ...
          <body data-token="${fn:escapeXml(token)}" data-racm="${fn:escapeXml(racmUrl)}"
            data-username="${fn:escapeXml(username)}" data-dashboard="${fn:escapeXml(dashboardUrl)}"
            data-dask-default-workers="${daskDefaultWorkers}" data-dask-default-memory="${daskDefaultMemory}"
            data-dask-default-threads="${daskDefaultThreads}" data-is-dask-available="${isDaskAvailable}">
            <%@ include file="../jspf/navbar.jspf" %>
              ...
              <main>
                ...
                <div class="container">
                  <c:if test="${not empty jobsMigrationUrl}">
                    <div id="jobs-migration-banner" class="alert alert-info jobs-migration-banner" role="region"
                      aria-label="Migration notice">
                      <button type="button" class="close" id="jobs-migration-dismiss"
                        aria-label="Dismiss migration notice">
                        <span aria-hidden="true">&times;</span>
                      </button>
                      <div class="jobs-migration-banner-copy">
                        <strong>Try the new Jobs experience.</strong>
                        <span>
                          We are migrating to a new app with the same core workflow plus new features.
                          You can opt in now and switch back any time.
                        </span>
                      </div>
                      <div class="jobs-migration-banner-actions">
                        <a class="btn btn-primary btn-sm" href="${fn:escapeXml(jobsMigrationUrl)}">Open New App</a>
                        <button type="button" class="btn btn-default btn-sm" id="jobs-migration-remind">Remind Me
                          Later</button>
                      </div>
                    </div>
                  </c:if>
                  ...
                  <div class="panel panel-primary">
                    <div class="panel-heading" id="jobs-heading">
                      ...
                      <div id="run-button-groups-holder">
                        ...
                        <button id="run-notebook-button" class="btn btn-success btn-sm disabled"
                          data-runtype="notebook">
                    ...
                    <p id="no-jobs-message" class="panel-body hidden">
                      Compute Jobs are available for longer, non-interactive tasks. Click one of the buttons above to
                      create a job.
                    </p>
                  </div>
                </div>
              ...
              <%@ include file="../jspf/footer.jspf" %>
                <%@ include file="../jspf/visit-dashboard-dialog.jspf" %>
                  <script type="text/javascript"
                    src="https://cdn.datatables.net/v/bs/dt-1.10.15/b-1.4.0/datatables.min.js"></script>
                  <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.18.1/moment.min.js"
                    integrity="sha256-1hjUhpc44NwiNg8OwMu2QzJXhD8kcj+sJA3aCQZoUjg=" crossorigin="anonymous"></script>
                  <script
                    src="https://cdn.datatables.net/plug-ins/1.10.15/features/conditionalPaging/dataTables.conditionalPaging.js"></script>
                  ...
                  <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-toast-plugin/1.3.1/jquery.toast.min.js"
                    integrity="sha256-jJcc8SMFEvXl7AqOTKSLOOxo9HxGbyeKZZHEzBVlXMs=" crossorigin="anonymous"></script>
                  ...
                  <script src="https://cdnjs.cloudflare.com/ajax/libs/vue/2.5.2/vue.js"
                    integrity="sha256-z1if//it5+Nk8vE5T+Oj4fQFt3lzPUCZBFB8nfSzBWo=" crossorigin="anonymous"></script>
                  <script src="https://cdnjs.cloudflare.com/ajax/libs/vuex/3.0.0/vuex.js"
                    integrity="sha256-qRemu2NyPYJXPb/GlIdqHuQKt0UNGTA8Fpyvp2zn21I=" crossorigin="anonymous"></script>
