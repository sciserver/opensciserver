...
@javax.persistence.Entity @javax.persistence.Table(name = "t_DatabaseContext")
...
@javax.persistence.NamedQueries({
        @javax.persistence.NamedQuery(name = "DatabaseContext.findById", query = "SELECT o FROM DatabaseContext o WHERE o.id = :id"),
        @javax.persistence.NamedQuery(name = "DatabaseContext.findByPublisherDID", query = "SELECT o FROM DatabaseContext o WHERE o.identity.publisherDID = :publisherDID")

        ,
        @javax.persistence.NamedQuery(name = "DatabaseContext.findByName", query = "SELECT o FROM DatabaseContext o WHERE o.name = :name")

})

public class DatabaseContext extends MetadataObject {
    ...
    protected RDBComputeDomain container;
    ...
    /**
     * Creates a new DatabaseContext for the given Container Entity.
     *
     * The Parent Container CAN NOT BE NULL
     *
     * @param pContainer the parent container CAN NOT BE NULL
     */
    public DatabaseContext(final RDBComputeDomain pContainer) {
        super();
     ...
     */
    public RDBComputeDomain getContainer() {
     ...
     */
    private void setContainerField(final RDBComputeDomain pContainer) {
    ...
    public boolean equals(final Object object, final boolean isDeep) {
        ...
        if (isDeep) {
            ...
            final DatabaseContext other = (DatabaseContext) object;
    ...
    public boolean setProperty(final String propertyName, final Object pValue) {
        ...
        if (!res) {
            ...
            if (PROPERTY_CONTAINER.equals(propertyName)) {
                setContainerField((RDBComputeDomain) pValue);
                return true;
            }
