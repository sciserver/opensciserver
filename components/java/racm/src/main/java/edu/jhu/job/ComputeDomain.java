...
@javax.persistence.Entity @javax.persistence.Table(name = "t_ComputeDomain")
...
@javax.persistence.NamedQueries({
        @javax.persistence.NamedQuery(name = "ComputeDomain.findById", query = "SELECT o FROM ComputeDomain o WHERE o.id = :id"),
        @javax.persistence.NamedQuery(name = "ComputeDomain.findByPublisherDID", query = "SELECT o FROM ComputeDomain o WHERE o.identity.publisherDID = :publisherDID")

        ,
        @javax.persistence.NamedQuery(name = "ComputeDomain.findByName", query = "SELECT o FROM ComputeDomain o WHERE o.name = :name")

})

public abstract class ComputeDomain extends MetadataRootEntityObject {
    ...
    private List<RootVolumeOnComputeDomain> rootVolume = null;
    ...
    @javax.persistence.ManyToOne(optional = true, fetch = javax.persistence.FetchType.LAZY, cascade = {
            ...
            javax.persistence.CascadeType.REFRESH }) @javax.persistence.JoinColumn(name = "resourceContextId", referencedColumnName = "id", nullable = true)
    ...
    /**
     * Creates a new ComputeDomain for the given Container Entity.
     *
     * The Parent Container CAN NOT BE NULL
     *
     * @param pContainer the parent container CAN NOT BE NULL
     */
    public ComputeDomain(final TransientObjectManager pContainer) {
        super(pContainer);
    }
     ...
     */
    public List<RootVolumeOnComputeDomain> getRootVolume() {
     ...
     */
    public void setRootVolume(final List<RootVolumeOnComputeDomain> pRootVolume) {
        this.rootVolume = pRootVolume;
    }

    /**
     * Add a RootVolumeOnComputeDomain to the collection
     * 
     * @param pRootVolumeOnComputeDomain RootVolumeOnComputeDomain to add
     */
    public void addRootVolume(final RootVolumeOnComputeDomain pRootVolumeOnComputeDomain) {
        if (this.rootVolume == null) {
            this.rootVolume = new ArrayList<RootVolumeOnComputeDomain>();
        }

        this.rootVolume.add(pRootVolumeOnComputeDomain);
    }
    ...
    public boolean equals(final Object object, final boolean isDeep) {
        ...
        if (isDeep) {
            ...
            final ComputeDomain other = (ComputeDomain) object;
