...
@javax.persistence.Entity @javax.persistence.Table(name = "t_AssociatedResource")
...
@javax.persistence.NamedQueries({
        @javax.persistence.NamedQuery(name = "AssociatedResource.findById", query = "SELECT o FROM AssociatedResource o WHERE o.id = :id"),
        @javax.persistence.NamedQuery(name = "AssociatedResource.findByPublisherDID", query = "SELECT o FROM AssociatedResource o WHERE o.identity.publisherDID = :publisherDID")

})

public class AssociatedResource extends MetadataObject {
    ...
    /**
     * Creates a new AssociatedResource.
     */
    ...
    /**
     * Creates a new AssociatedResource for the given Container Entity.
     *
     * The Parent Container CAN NOT BE NULL
     *
     * @param pContainer the parent container CAN NOT BE NULL
     */
    public AssociatedResource(final Resource pContainer) {
        super();
    ...
    protected void setContainer(final Resource pContainer) {
        ...
        pContainer.addAssociatedResource(this);
    }
    ...
    public boolean equals(final Object object, final boolean isDeep) {
        ...
        if (isDeep) {
            ...
            final AssociatedResource other = (AssociatedResource) object;
