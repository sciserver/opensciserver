...
/**
 * UML Object RootVolumeOnComputeDomain :
 *
 * 
...
@javax.persistence.Entity @javax.persistence.Table(name = "t_RootVolumeOnComputeDomain")
...
@javax.persistence.NamedQueries({
        @javax.persistence.NamedQuery(name = "RootVolumeOnComputeDomain.findById", query = "SELECT o FROM RootVolumeOnComputeDomain o WHERE o.id = :id"),
        @javax.persistence.NamedQuery(name = "RootVolumeOnComputeDomain.findByPublisherDID", query = "SELECT o FROM RootVolumeOnComputeDomain o WHERE o.identity.publisherDID = :publisherDID")

})

public class RootVolumeOnComputeDomain extends MetadataObject {
    ...
    protected ComputeDomain container;
    ...
    @javax.persistence.Basic(optional = false) @javax.persistence.Column(name = "path", nullable = false)
    ...
    @javax.persistence.Basic(optional = true) @javax.persistence.Column(name = "displayName", nullable = true)
    ...
    /**
     * Creates a new RootVolumeOnComputeDomain.
     */
    protected RootVolumeOnComputeDomain() {
        super();
    }

    /**
     * Creates a new RootVolumeOnComputeDomain for the given Container Entity.
     *
     * The Parent Container CAN NOT BE NULL
     *
     * @param pContainer the parent container CAN NOT BE NULL
     */
    public RootVolumeOnComputeDomain(final ComputeDomain pContainer) {
        super();
    ...
    /**
     * Defines path Attribute
     * 
     * @param pPath value to set
     */
     ...
     */
    public ComputeDomain getContainer() {
     ...
     */
    private void setContainerField(final ComputeDomain pContainer) {
     ...
     */
    protected void setContainer(final ComputeDomain pContainer) {
        if (pContainer == null) {
    ...
    public boolean equals(final Object object, final boolean isDeep) {
        ...
        if (isDeep) {
            ...
            final RootVolumeOnComputeDomain other = (RootVolumeOnComputeDomain) object;

            if (!areEquals(this.path, other.path)) {
                return false;
            }
    ...
    public boolean setProperty(final String propertyName, final Object pValue) {
        ...
        if (!res) {
            ...
            if (PROPERTY_CONTAINER.equals(propertyName)) {
                setContainerField((ComputeDomain) pValue);
                return true;
            }

            if ("path".equals(propertyName)) {
                setPath((String) pValue);
                return true;
            }
    ...
    protected StringBuilder deepToString(final StringBuilder sb, final boolean isDeep,
        ...
        sb.append("path=");
        if (getPath() != null) {
            MetadataElement.deepToString(sb, isDeep, ids, getPath());
        }
        sb.append(", ");
    ...
    public String validationErrors() {
        ...
        if (path == null)
            sb.append("- atribute 'path' cannot be null\n");
