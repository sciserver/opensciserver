...
@javax.persistence.Entity @javax.persistence.Table(name = "t_Response")
...
@javax.persistence.NamedQueries({
        @javax.persistence.NamedQuery(name = "Response.findById", query = "SELECT o FROM Response o WHERE o.id = :id"),
        @javax.persistence.NamedQuery(name = "Response.findByPublisherDID", query = "SELECT o FROM Response o WHERE o.identity.publisherDID = :publisherDID")

})

public class Response extends MetadataObject {
    ...
    protected JobMessage container;
    ...
    @javax.persistence.ManyToOne(optional = false, fetch = javax.persistence.FetchType.LAZY, cascade = {
            ...
            javax.persistence.CascadeType.REFRESH }) @javax.persistence.JoinColumn(name = "messageId", referencedColumnName = "id", nullable = false)

    private JobMessage message = null;
    /**
     * "lazy" version of the message reference. Used by XML (un)marshallers to resolve possibly inderectly referenced
     * resource JobMessage.
     */

    @javax.persistence.Transient

    protected Reference p_message = null;
    ...
    /**
     * Creates a new Response for the given Container Entity.
     *
     * The Parent Container CAN NOT BE NULL
     *
     * @param pContainer the parent container CAN NOT BE NULL
     */
    public Response(final JobMessage pContainer) {
        super();
        this.setContainer(pContainer);
    }

    /**
     * Returns message Reference If the message variable is null but its "lazy" version p_message is not, that lazy
    ...
    public JobMessage getMessage() {
        ...
        if (this.message == null && this.p_message != null) {
            this.message = (JobMessage) resolve(this.p_message, JobMessage.class);
        }
        return this.message;
    ...
    /**
     * Defines message Reference
     * 
     * @param pMessage reference to set
     */
    public void setMessage(final JobMessage pMessage) {
     ...
     */
    public JobMessage getContainer() {
     ...
     */
    private void setContainerField(final JobMessage pContainer) {
    ...
    public boolean setProperty(final String propertyName, final Object pValue) {
        ...
        if (!res) {
            ...
            if (PROPERTY_CONTAINER.equals(propertyName)) {
                setContainerField((JobMessage) pValue);
                return true;
            }

            if ("message".equals(propertyName)) {
                setMessage((JobMessage) pValue);
                return true;
            }
    ...
    protected void prepareReferencesForMarshalling() {
        ...
        if (getMessage() != null) {
            this.p_message = getMessage().asReference();
            if (getStateFor(getMessage()).isToBeMarshalled()) {
                getMessage().setXmlId();
            }
        }
    ...
    public boolean isValid() {
        if (!super.isValid())
            return false;
        boolean isOk = true;
        isOk = isOk && (message != null || p_message != null);
        return isOk;
    }
    ...
    public String validationErrors() {
        ...
        if (message == null && p_message == null)
            sb.append("- reference 'message' cannot be null\n");
