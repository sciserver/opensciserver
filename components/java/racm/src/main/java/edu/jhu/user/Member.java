...
@javax.persistence.Entity @javax.persistence.Table(name = "t_Member")
...
@javax.persistence.NamedQueries({
        @javax.persistence.NamedQuery(name = "Member.findById", query = "SELECT o FROM Member o WHERE o.id = :id"),
        @javax.persistence.NamedQuery(name = "Member.findByPublisherDID", query = "SELECT o FROM Member o WHERE o.identity.publisherDID = :publisherDID")

})

public class Member extends MetadataObject {
    ...
    @javax.persistence.Basic(optional = true) @javax.persistence.Enumerated(javax.persistence.EnumType.STRING) @javax.persistence.Column(name = "memberRole", nullable = true)
    ...
    @javax.persistence.Basic(optional = false) @javax.persistence.Enumerated(javax.persistence.EnumType.STRING) @javax.persistence.Column(name = "status", nullable = false)
    ...
    /**
     * Creates a new Member for the given Container Entity.
     *
     * The Parent Container CAN NOT BE NULL
     *
     * @param pContainer the parent container CAN NOT BE NULL
     */
    public Member(final UserGroup pContainer) {
        super();
        this.setContainer(pContainer);
    }

    /**
     * Returns memberRole Attribute
     * 
     * @return memberRole Attribute
     */
    public GroupRole getMemberRole() {
        return this.memberRole;
    }

    /**
     * Defines memberRole Attribute
     * 
     * @param pMemberRole value to set
     */
    public void setMemberRole(final GroupRole pMemberRole) {
        this.memberRole = pMemberRole;
    }
     ...
     */
    public void setStatus(final MemberStatus pStatus) {
        this.status = pStatus;
    }
     ...
     */
    private void setContainerField(final UserGroup pContainer) {
    ...
    public boolean equals(final Object object, final boolean isDeep) {
        ...
        if (isDeep) {
            ...
            if (!areEquals(this.memberRole, other.memberRole)) {
                return false;
            }
    ...
    public Object getProperty(final String propertyName) {
        ...
        if ("memberRole".equals(propertyName)) {
    ...
    public boolean setProperty(final String propertyName, final Object pValue) {
        ...
        if (!res) {
            ...
            if (PROPERTY_CONTAINER.equals(propertyName)) {
                setContainerField((UserGroup) pValue);
                return true;
            }

            if ("memberRole".equals(propertyName)) {
                setMemberRole((GroupRole) pValue);
                return true;
            }

            if ("status".equals(propertyName)) {
                setStatus((MemberStatus) pValue);
                return true;
            }
    ...
    protected StringBuilder deepToString(final StringBuilder sb, final boolean isDeep,
        ...
        if (getMemberRole() != null) {
            MetadataElement.deepToString(sb, isDeep, ids, getMemberRole());
        }
        sb.append(", ");
        sb.append("status=");
        if (getStatus() != null) {
