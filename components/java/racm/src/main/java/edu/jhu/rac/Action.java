...
@javax.persistence.Entity @javax.persistence.Table(name = "t_Action")
...
@javax.persistence.NamedQueries({
        @javax.persistence.NamedQuery(name = "Action.findById", query = "SELECT o FROM Action o WHERE o.id = :id"),
        @javax.persistence.NamedQuery(name = "Action.findByPublisherDID", query = "SELECT o FROM Action o WHERE o.identity.publisherDID = :publisherDID")

        ,
        @javax.persistence.NamedQuery(name = "Action.findByName", query = "SELECT o FROM Action o WHERE o.name = :name")
...
public class Action extends MetadataObject {
    ...
    @javax.persistence.Basic(optional = true) @javax.persistence.Enumerated(javax.persistence.EnumType.STRING) @javax.persistence.Column(name = "category", nullable = true)
    ...
    /**
     * Creates a new Action for the given Container Entity.
     *
     * The Parent Container CAN NOT BE NULL
     *
     * @param pContainer the parent container CAN NOT BE NULL
     */
    public Action(final ResourceType pContainer) {
        super();
     ...
     * 
     * @param pCategory value to set
     */
    public void setCategory(final ActionCategory pCategory) {
    ...
    public boolean equals(final Object object, final boolean isDeep) {
        ...
        if (isDeep) {
            ...
            if (!areEquals(this.category, other.category)) {
                return false;
            }
    ...
    public boolean setProperty(final String propertyName, final Object pValue) {
        ...
        if (!res) {
            ...
            if ("category".equals(propertyName)) {
                setCategory((ActionCategory) pValue);
                return true;
            }
    ...
    protected StringBuilder deepToString(final StringBuilder sb, final boolean isDeep,
        ...
        sb.append("category=");
        if (getCategory() != null) {
            MetadataElement.deepToString(sb, isDeep, ids, getCategory());
        }
