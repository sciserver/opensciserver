...
@javax.persistence.Entity @javax.persistence.Table(name = "t_RootVolume")
...
@javax.persistence.NamedQueries({
        @javax.persistence.NamedQuery(name = "RootVolume.findById", query = "SELECT o FROM RootVolume o WHERE o.id = :id"),
        @javax.persistence.NamedQuery(name = "RootVolume.findByPublisherDID", query = "SELECT o FROM RootVolume o WHERE o.identity.publisherDID = :publisherDID")

        ,
        @javax.persistence.NamedQuery(name = "RootVolume.findByName", query = "SELECT o FROM RootVolume o WHERE o.name = :name")

})

public class RootVolume extends MetadataObject {
    ...
    /**
     * Attribute name : The name in which volumes contained by this UserVolume are shown by the user. If multiple
     * volumes within this root volume are accessible by a user, it is important that UserVolume.owner be used to
     * differientate the volumes. ( Multiplicity : 1 )
     */
    ...
    /**
     * Attribute description : Human-readable description of the volumes contained in this root volume. ( Multiplicity :
     * 0..1 , MaxLength : -1 )
     */
    ...
    /**
     * Attribute pathOnFileSystem : The path of this volume on the file system of the FileService. ( Multiplicity : 1 )
     */
    ...
    /**
     * Attribute containsSharedVolumes :
     * 
     * TODO : Missing description : please, update your UML model asap.
     * 
     * ( Multiplicity : 1 )
    ...
    @javax.persistence.Basic(optional = false) @javax.persistence.Column(name = "containsSharedVolumes", nullable = false)

    private Boolean containsSharedVolumes;
    ...
    /**
     * Creates a new RootVolume.
     */
    protected RootVolume() {
        super();
    }

    /**
     * Creates a new RootVolume for the given Container Entity.
     *
     * The Parent Container CAN NOT BE NULL
     *
     * @param pContainer the parent container CAN NOT BE NULL
     */
    public RootVolume(final FileService pContainer) {
        super();
    ...
    /**
     * Returns containsSharedVolumes Attribute
     * 
     * @return containsSharedVolumes Attribute
     */
    public Boolean getContainsSharedVolumes() {
        return this.containsSharedVolumes;
    }

    /**
     * Defines containsSharedVolumes Attribute
     * 
     * @param pContainsSharedVolumes value to set
     */
    public void setContainsSharedVolumes(final Boolean pContainsSharedVolumes) {
        this.containsSharedVolumes = pContainsSharedVolumes;
    }
    ...
    public boolean equals(final Object object, final boolean isDeep) {
        ...
        if (isDeep) {
            ...
            final RootVolume other = (RootVolume) object;
            ...
            if (!areEquals(this.containsSharedVolumes, other.containsSharedVolumes)) {
                return false;
            }
    ...
    public Object getProperty(final String propertyName) {
        ...
        if ("containsSharedVolumes".equals(propertyName)) {
            return getContainsSharedVolumes();
        }
    ...
    public boolean setProperty(final String propertyName, final Object pValue) {
        ...
        if (!res) {
            ...
            if ("containsSharedVolumes".equals(propertyName)) {
                setContainsSharedVolumes((Boolean) pValue);
                return true;
            }
    ...
    protected StringBuilder deepToString(final StringBuilder sb, final boolean isDeep,
        ...
        sb.append(", ");
        sb.append("containsSharedVolumes=");
        if (getContainsSharedVolumes() != null) {
            MetadataElement.deepToString(sb, isDeep, ids, getContainsSharedVolumes());
        }
        sb.append(", ");
    ...
    public boolean isValid() {
        ...
        isOk = isOk && containsSharedVolumes != null;
    ...
    public String validationErrors() {
        ...
        if (containsSharedVolumes == null)
            sb.append("- atribute 'containsSharedVolumes' cannot be null\n");
