...
@javax.persistence.Entity @javax.persistence.Table(name = "t_DockerImage")
...
@javax.persistence.DiscriminatorValue("DockerImage")

@javax.persistence.NamedQueries({
        @javax.persistence.NamedQuery(name = "DockerImage.findById", query = "SELECT o FROM DockerImage o WHERE o.id = :id"),
        @javax.persistence.NamedQuery(name = "DockerImage.findByPublisherDID", query = "SELECT o FROM DockerImage o WHERE o.identity.publisherDID = :publisherDID")

})

public class DockerImage extends ComputeResource {
    ...
    /**
     * Creates a new DockerImage for the given Container Entity.
     *
     * The Parent Container CAN NOT BE NULL
     *
     * @param pContainer the parent container CAN NOT BE NULL
     */
    public DockerImage(final DockerComputeDomain pContainer) {
        super(pContainer);
    }
    ...
    public boolean equals(final Object object, final boolean isDeep) {
        ...
        if (isDeep) {
            ...
            final DockerImage other = (DockerImage) object;
