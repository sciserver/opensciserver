...
@javax.persistence.Entity @javax.persistence.Table(name = "t_SciserverEntity")
...
@javax.persistence.NamedQueries({
        @javax.persistence.NamedQuery(name = "SciserverEntity.findById", query = "SELECT o FROM SciserverEntity o WHERE o.id = :id"),
        @javax.persistence.NamedQuery(name = "SciserverEntity.findByPublisherDID", query = "SELECT o FROM SciserverEntity o WHERE o.identity.publisherDID = :publisherDID")

})

public abstract class SciserverEntity extends MetadataRootEntityObject {
    ...
    /**
     * Creates a new SciserverEntity.
     */
    protected SciserverEntity() {
        super();
    }

    /**
     * Creates a new SciserverEntity for the given Container Entity.
     *
     * The Parent Container CAN NOT BE NULL
     *
     * @param pContainer the parent container CAN NOT BE NULL
     */
    public SciserverEntity(final TransientObjectManager pContainer) {
        super(pContainer);
    }
    ...
    public boolean equals(final Object object, final boolean isDeep) {
        ...
        if (isDeep) {
            ...
            final SciserverEntity other = (SciserverEntity) object;
