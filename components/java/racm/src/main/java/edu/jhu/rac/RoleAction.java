...
@javax.persistence.Entity @javax.persistence.Table(name = "t_RoleAction")
...
@javax.persistence.NamedQueries({
        @javax.persistence.NamedQuery(name = "RoleAction.findById", query = "SELECT o FROM RoleAction o WHERE o.id = :id"),
        @javax.persistence.NamedQuery(name = "RoleAction.findByPublisherDID", query = "SELECT o FROM RoleAction o WHERE o.identity.publisherDID = :publisherDID")

})

public class RoleAction extends MetadataObject {
    ...
    /**
     * Creates a new RoleAction for the given Container Entity.
     *
     * The Parent Container CAN NOT BE NULL
     *
     * @param pContainer the parent container CAN NOT BE NULL
     */
    public RoleAction(final Role pContainer) {
        super();
     ...
     */
    private void setContainerField(final Role pContainer) {
     ...
     */
    protected void setContainer(final Role pContainer) {
        if (pContainer == null) {
    ...
    public boolean equals(final Object object, final boolean isDeep) {
        ...
        if (isDeep) {
            ...
            final RoleAction other = (RoleAction) object;
